...
function Mealitem(props) {
    let displayMeal = MealData.filter(meal =>meal.categoryid == props.selectedcategory.id)

    const showName = itemData =>{
    ...
    return (
        <MealList listData={displayMeal} showName={showName} />
    );
}
...
//     return(
//         <View>
//             <Text>This is meal Item Screen</Text>
//         </View>
//     )
// }
